<?php
	...
	{
		$sql2 = "INSERT into capms_admin_individual_leaves (id, leave_id, user_id, reason_of_leave, type_of_leave, leave_status, leave_date, created_at, updated_at) VALUES (NULL, '".$last_insert_id."', '".$emp_id."', '".$reason_of_leave."', '".$type_of_leave."', 'Pending', '".$eachDate."', '".date('d-m-Y g:i A', strtotime('now'))."', '".date('d-m-Y g:i A', strtotime('now'))."')";
