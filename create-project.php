                            ...
                            <section class="custom-projects">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    if(isset($_POST['create'])){
                                      ...
                                      $query=mysqli_query($con, "INSERT INTO capms_admin_project(project_id, project_name, project_priority, project_sdate, project_edate, project_deadline, project_team, project_details, file_upload) VALUES ('','$project_name','$project_priority','$project_sdate','$project_edate','$project_deadline','$team','$project_details','$destfile')");
