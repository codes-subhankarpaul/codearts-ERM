...
<head>
    ...
    <title>Edit Notice - CERM :: Codearts Employee Relationship Management</title>
</head>
<?php
    $sid = $_GET['id'];
                            ...
                            <section class="notfication-body">
                                <form style="padding-top: 130px;" method="POST" enctype="multipart/form-data" id="noticeForm">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="noticeSubject" placeholder="Enter Notification Subject" name="noticeSubject" value='<?php echo $data["notice_subject"]; ?>' required>
                                    </div>
                                    <div class="form-group">
                                        <label for="noticeBody">Notice Content</label>
                                        <textarea class="form-control" id="editor" name="noticeBody"><?php echo $data["notice_body"]; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="noticeFile">Choose file...</label>
                                        <input type="file" id="noticeFile" name="noticeFile" accept="image/*, application/pdf" hidden="hidden">
