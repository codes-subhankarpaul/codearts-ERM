...
$timesheet_update_sql = "UPDATE `capms_user_timesheet` SET `user_id`='".$_SESSION['emp_id']."',`workload_id`='".$workload_id."',`timesheet_date`='".$timesheet_date."',`start_time`='".$start_time."',`end_time`='".$end_time."',`task_domain`='".$task_domain."',`task_type`='".$task_type."',`description`='".$description."',`trello_link`='".$trello_link."',`created_at`='".$created_at."',`updated_at`='".$updated_at."' WHERE `timesheet_id` = '".$_REQUEST['id']."'";
